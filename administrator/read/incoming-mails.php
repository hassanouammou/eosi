<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET' && !empty($_GET)) {
        ...
        $incoming_mails = $administrator -> get_incoming_mails();
            ...
            <form method="post" class="form">
                <div class="smta">
                    ...
                    <div id="non-year-options">
                        ...
                        <a title="Ajouter Un Nouveau Courrier" href="../create/incoming-mail.php">Ajouter</a>
                        <button id="update-button" type="submit" name="update_incoming_mail">Modifier</button>
                                ...
                                if (!(count($incoming_mails) === 0)) {
                                    foreach ($incoming_mails as $incoming_mail) {
                                        ...
                                        echo "
                                            <tr>
                                                <td>
                                                    <input class='checked_incoming_mails' type='checkbox' 
                                                    name='checked_incoming_mails[]' 
                                                    value='{$incoming_mail -> get('id')}'/>
                                                </td>
                ...
                <div id="delete-pop-up" class="attention--pop-up">
                    ...
                    <div class="dialog-decisions">
                        <button type="submit" name="delete_incoming_mail">Oui</button>
