<?php 
    ...
    $userpath = <<<HTML
        ...
        <li><a href="outgoing-mail.php">Ajoutation</a></li>
    HTML;
    if (isset($_POST['create_outgoing_mail'])) {
        ...
        $outgoing_mails_link  = "{$CONSTANT('OUTGOING_MAILS_UPLOAD_STORAGE_LINK')}/$electronic_mail_name";
        if (move_uploaded_file($electronic_mail['tmp_name'], $outgoing_mails_link)) {
            $administrator -> create_outgoing_mail(
            ...
            rename($outgoing_mails_link, $secure_link);
...
<head>
    <?= Page::get_head() ?>
    <link rel="stylesheet" href="../asset/style/create/outgoing-mail.css">
    <title>Ajouter Un Courrier de Départ | Bureau d'Ordre</title>
</head>
<body>
    <div id="container" class="container">
        ...
        <main id="main" class="main">
            <form  class="form" method="post" enctype="multipart/form-data">
                ...
                <div class="main-form">
                    <span>Ajouter Un Courrier de Départ</span>
                    <div class="input">
                ...
                <div id="add-pop-up" class="attention--pop-up">
                    ...
                    <div class="dialog-decisions">
                        <button type="submit" type="submit" name="create_outgoing_mail">Oui</button>
