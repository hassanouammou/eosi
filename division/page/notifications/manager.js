    ...
    function fetchNotifications() {
        var notificationsCercle = setInterval(() => {
            ...
            xhrForNotificationsLength.open(
                "get", "/eosi/division/page/notifications/notifications.php?query=fetch-notifications-length"
            );
            ...
            // Notifications
            xhrForNotifications.open("get", "/eosi/division/page/notifications/notifications.php?query=fetch-notifications");
            ...
            notificationsOpener.onclick = () => {
                if (notificationsDropdown.style.visibility == "visible") {
                    ...
                    xhrToClearNotifications.open("get", "/eosi/division/page/notifications/notifications.php?query=clear");
