<?php
    class Page {
        public static function to_login_if_no_session_was_created($user_id, $user_role) {
            if (!($_SESSION['user_id'] === $user_id && $_SESSION['user_role'] === "division")) {
        ...
        public static function get_head() : string {
            return <<<HTML
                ...
                <link rel="stylesheet" href="/eosi/division/page/style.css">
                <script src="/eosi/division/page/main.js"></script>
                ...
                <script src="/eosi/division/page/notifications/manager.js"></script>
            HTML;
        }
                        ...
                        <nav id="profile-and-logout-dropdown">
                            <ul>
                                <li>
                                    ...
                                    <a href="/eosi/division/read/profile.php">Mon Profile</a>
                                </li>
                                <li>
                ...
                <nav id="navbar">
                    <ul id="first-navbar">
                        <li>
                            ...
                            <a href="/eosi/division/read/dashboard.php">Le Tableau de Board</a>
                        </li>
                        <li id="exception-li-aside">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <a href="/eosi/division/read/outgoing-mails.php">
                                        Courriers de Départ
                                    </a>
                                </li>
                                <li>
                                    <i class="fa-solid fa-reply"></i>
                                    <a href="/eosi/division/read/incoming-mails.php">
                                        Courriers à Arrivée
                                    </a>
                                </li>
                            </ul>
                    ...
                    <ul id="last-navbar">
                        <li>
                            ...
                            <a href="/eosi/division/read/employees.php">Les Employés</a>
                        </li>
                    </ul>
                </nav>
            HTML;
